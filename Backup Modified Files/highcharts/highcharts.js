    ...
    (function (a) {
        ...
        a.Series = a.seriesType("line", null, {
            ...
            drawPoints: function () {
                ...
                e = this.xAxis;
                var r, x = b(h.enabled, !e || e.isRadial ? 1 : null, this.closestPointRangePx >= h.enabledThreshold * h.radius);
                if (!0 === h.enabled || this._hasPointMarkers)
                    for (e = 0; e < a.length; e++){ 
                    c = a[e], g = c.graphic, l = c.marker || {}, k = !!c.marker, f = x && void 0 === l.enabled || l.enabled, n = !1 !== c.isInside, f && !c.isNull ? (f = b(l.symbol, this.symbol), r = this.markerAttribs(c,
                        c.selected && "select"), g ? g[n ? "show" : "hide"](!0).animate(r) : n && (0 < r.width || c.hasImage) && (c.graphic = g = d.renderer.symbol(f, r.x, r.y, r.width, r.height, k ? l : h).add(u)), g && !d.styledMode && g.attr(this.pointAttribs(c, c.selected && "select")), g && g.addClass(c.getClassName(), 1)) : g && (c.graphic = g.destroy())
                    }},
