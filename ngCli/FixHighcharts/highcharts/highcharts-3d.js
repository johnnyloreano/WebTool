...
(function (z) {
    ...
    (function (b) {
        ...
        b.perspective = function (r, t, u) {
            var q = t.options.chart.options3d,
                h = u ? t.inverted : !1,
                v = {
                    x: t.plotWidth / 2,
                    y: t.plotHeight / 2,
        ...
        b.pointCameraDistance = function (b, t) {
            var u = t.options.chart.options3d,
                q = t.plotWidth /
                2;
            t = t.plotHeight / 2;
    ...
    (function (b) {
        ...
        p.prototype.face3d = function (a) {
            ...
            d.attr = function (a) {
                if ("object" === typeof a && (v(a.enabled) || v(a.vertexes) || v(a.insidePlotArea))) {
                    ...
                    var d = k(this.vertexes, q[f.chartIndex], this.insidePlotArea),
                        e = f.toLinePath(d, !0),
                        d = b.shapeArea(d),
        ...
        m = b.merge(e, {
            ...
            animate: function (a, e, d) {
                v(a.x) && v(a.y) ? (a = this.renderer[this.pathType + "Path"](a), this.singleSetterForParts("d", null, a, "animate", e, d), this.attr({
                    zIndex: a.zIndexes.group
                })) : a.opacity ? this.processParts(a,
        ...
        b.SVGRenderer.prototype.cuboidPath = function (a) {
            ...
            var d = a.x,
                ...
                w = a.depth,
                n = q[this.chartIndex],
                m, p, u = n.options.chart.options3d.alpha,
                t = 0,
                h = [{
                    x: d,
                    y: f,
        ...
        b.SVGRenderer.prototype.arc3d = function (e) {
            ...
            var d = this.g(),
                f = d.renderer,
                k = "x y r innerR start end".split(" ");
            e = a(e);
            e.alpha = (e.alpha || 0) * w;
            e.beta = (e.beta || 0) * w;
            d.top = f.path();
            ...
            d.animate = function (e, f, g) {
                var w, k = this.attribs,
                    m, p = "data-" + Math.random().toString(26).substring(2,
                        9);
                delete e.center;
                delete e.z;
                delete e.depth;
        ...
        p.prototype.arc3dPath = function (a) {
            ...
            var u = Math.sin(b),
                ...
                C = w * Math.sin(k),
                w = ["M", d + h * n, c + g * p],
                w = w.concat(x(d, c, h, g, f, b, 0, 0)),
                w = w.concat(["L", d + q * a, c + v * u]),
                w = w.concat(x(d, c, q, v, b, f, 0, 0)),
                w = w.concat(["Z"]),
                z = 0 < m ? Math.PI / 2 : 0,
                m = 0 < k ? 0 : Math.PI / 2,
                z = f > -z ? f : b > -z ? -z : f,
                D = b < r - m ? b : f < r - m ? r - m : b,
                E = 2 * r - m,
                k = ["M", d + h * y(z), c + g * t(z)],
    ...
    (function (b) {
        ...
        h(r.prototype, "renderSeries", function (b) {
            ...
            if (this.is3d())
                for (; g--;) b = this.series[g], b.translate(), b.render();
            else b.call(this)
        });
        y(r, "afterDrawChartBox", function () {
            if (this.is3d()) {
                var w =
                    this.renderer,
                    g = this.options.chart.options3d,
                    a = this.get3dFrame(),
                    k = this.plotLeft,
                    n = this.plotLeft + this.plotWidth,
                    l = this.plotTop,
                    p = this.plotTop + this.plotHeight,
                    g = g.depth,
                    c = k - (a.left.visible ? a.left.size : 0),
                    e = n + (a.right.visible ? a.right.size : 0),
                    m = l - (a.top.visible ? a.top.size : 0),
                    f = p + (a.bottom.visible ? a.bottom.size : 0),
                    h = 0 - (a.front.visible ? a.front.size : 0),
                    d = g + (a.back.visible ? a.back.size : 0),
        ...
        r.prototype.get3dFrame = function () {
            var h = this,
                ...
                a = g.frame,
                k = h.plotLeft,
                n = h.plotLeft + h.plotWidth,
                l = h.plotTop,
                p = h.plotTop + h.plotHeight,
                c = g.depth,
                e = function (a) {
                    a =
                        b.shapeArea3d(a, h);
            ...
            var z = function (a, c, e) {
                    for (var d = ["size", "color", "visible"], b = {}, f = 0; f < d.length; f++)
                        for (var g = d[f], k = 0; k < a.length; k++)
    ...
    (function (b) {
        function x(c, e, b) {
            ...
            var f = c.chart,
                g = q * f.options.chart.options3d.alpha,
                d = q * f.options.chart.options3d.beta,
        ...
        p(t.prototype, "getPlotLinePath", function (a) {
            ...
            var b = this.chart,
                ...
                f = this.isZAxis ? b.plotWidth : f.depth,
                b = b.frame3d,
                c = [this.swapZ({
                    x: c[1],
                    y: c[2],
        ...
        p(t.prototype, "getPlotBandPath",
            function (a) {
                ...
                if (c && b)
                    for (var g = 0; g < c.length; g += 6) f.push("M", c[g + 1], c[g + 2], "L", c[g + 4], c[g + 5], "L", b[g + 4], b[g + 5], "L", b[g + 1], b[g + 2], "Z");
                return f
            });
        ...
        t.prototype.swapZ = function (a,
            b) {
            return this.isZAxis ? (b = b ? 0 : this.chart.plotLeft, {
                x: b + a.z,
                y: a.y,
                z: a.x - b
            }) : a
        ...
        p(t.prototype, "getSlotWidth", function (c, b) {
            if (this.chart.is3d() && b && b.label && this.categories && this.chart.frameShapes) {
                var e = this.chart,
                    f = this.ticks,
                    l = this.gridGroup.element.childNodes[0].getBBox(),
                    d = e.frameShapes.left.getBBox(),
                    h = e.options.chart.options3d,
                    e = {
                        x: e.plotWidth / 2,
                        y: e.plotHeight / 2,
                        z: h.depth / 2,
    ...
    (function (b) {
        ...
        b.Series.prototype.translate3dPoints = function () {
            var b = this.chart,
                u = r(this.zAxis, b.options.zAxis[0]),
                q = [],
                h, v, w;
        ...
        y(u, "afterInit", function () {
            if (this.chart.is3d() && this.handle3dGrouping) {
                var b = this.options,
                    g = b.grouping,
                    a = b.stacking,
                    h = t(this.yAxis.options.reversedStacks, !0),
                    n = 0;
                if (void 0 === g || g) {
        ...
        b(r.pie.prototype, "translate", function (b) {
            ...
            if (this.chart.is3d()) {
                var q = this,
                    h = q.options,
                    u = h.depth || 0,
                    r = q.chart.options.chart.options3d,
                    g = r.alpha,
                    a = r.beta,
                    k = h.stacking ? (h.stack || 0) * u : q._i *
                    u,
                    k = k + u / 2;
                !1 !== h.grouping && (k = 0);
            ...
            if (this.chart.is3d()) {
                ...
                this.data.forEach(function (b) {
                    ...
                    var a = b.connectorPosition,
                        k = -r * (1 - Math.cos((h.alpha || q.alpha) * x)) * Math.sin(g),
